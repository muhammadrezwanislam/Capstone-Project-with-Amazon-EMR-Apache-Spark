...
def create_redshift_security_group():
	"""
	Creates redshift security group and return security group id 
	"""
...
def get_iam_role_arns():
	"""
	Gets Amazon Resource Number (ARN) created before
	"""
...
def create_redshift_cluster():
	"""
	Creates Amazon Redshift Cluster
	"""
...
def get_redshift_cluster_endpoint():
	"""
	Returns the redshift cluster endpoint
	"""
    redshift_client = boto3.client('redshift')
...
def create_tables():
	"""
	Creates database table based on schema
	"""
